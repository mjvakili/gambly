...
model.param_dict['mean_occupation_centrals_assembias_param1'] = 1.0
nsat_a1_old = model.mean_occupation_centrals(prim_haloprop = mass, sec_haloprop_percentile=0)
nsat_a1_young = model.mean_occupation_centrals(prim_haloprop = mass, sec_haloprop_percentile=1)
############# half of maximum allowable assembly bias ############

model.param_dict['mean_occupation_centrals_assembias_param1'] = 0.5
nsat_a05_old = model.mean_occupation_centrals(prim_haloprop = mass, sec_haloprop_percentile=0)
nsat_a05_young = model.mean_occupation_centrals(prim_haloprop = mass, sec_haloprop_percentile=1)

############# Model with no assemly bias ########################
nsat_baseline = baseline_model.mean_occupation_centrals(prim_haloprop = mass)
...
title = ax.set_title('Central Galaxies with positive assembly bias', fontsize=20)
...
fig2_sats.savefig('ncens.pdf', bbox_extra_artists=[xlabel, ylabel], bbox_inches='tight')
...
xlabel = ax.set_xlabel(r'$M_{\rm vir} [M_{\odot}]$', fontsize=25)
ylabel = ax.set_ylabel(r'$\langle N_{\rm c}\rangle$', fontsize=25)
title = ax.set_title('Central Galaxies with negative assembly bias', fontsize=20)
...
fig2_sats.savefig('ncens2.pdf', bbox_extra_artists=[xlabel, ylabel], bbox_inches='tight')
