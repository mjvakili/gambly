...
def load_hod_random_guess(Mr):
    ...
    if Mr == 21.5:
        pos = [13.4 , 0.6 , 12.6 , 1.3 , 14.52]
    if Mr == 21.:
        pos = [12.74 , 0.34 , 12.61 , 1.17 , 13.99]
    if Mr == 20.5:
        pos = [12.31 , 0.2 , 12.36 , 1.11 , 13.56]
    if Mr == 20.:
        pos = [12.01 , 0.32 , 11.7 , 1.08 , 13.3]
    if Mr == 19.5:
        pos = [11.78 , 0.2 , 11.1 , 1.05 , 13.01]
    if Mr == 19.:
...
def load_dechod_random_guess(Mr):
    ...
    if Mr == 21.5:
        pos = [13.43 , 0.6 , 12.59 , 1.27 , 14.54 , 0.0 , 0.0]
    if Mr == 21.:
        pos = [12.8 , 0.47 , 12.51 , 1.08 , 14.02 , 0.3 , 0.18]
    if Mr == 20.5:
        pos = [12.42 , 0.44 , 12.3 , 1.06 , 13.58 , 0.7 , 0.1]
    if Mr == 20.:
        pos = [12.23 , 0.3 , 11.6 , 1.00 , 13.3 , 0.7 , 0.1]
    if Mr == 19.5:
        pos = [11.80 , 0.3 , 11.2 , 1.05 , 13.01 , 0.5 , 0.1]
    if Mr == 19.:
