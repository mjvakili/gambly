...
of the simulation, and Cd is the covariance of the data. This has been explained in detail in Section 2.3. 
...
In fact in emcee, the walkers are not indpendent Markov chains. As a result, we cannot use 
...
This has been explained in second-to-last paragraph of Section 4.
...
The phrasing of Section 2.1 has been clarified. A simillar pharsing is dropped from the first paragraph of Section 6 to avoid confusion. 
...
Conroy et al. (2006) has been included in the citations for abundance matching via V_max.
